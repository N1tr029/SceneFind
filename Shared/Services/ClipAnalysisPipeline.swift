    ...
    private func buildCandidates(request: SharedClipRequest, subtitleMatches: [SubtitleMatch], detectedDialogue: String) -> [SceneCandidate] {
        subtitleMatches.compactMap { match in
            ...
            return SceneCandidate(
                ...
                seasonNumber: title.mediaType == .television ? episode.seasonNumber : nil,
                episodeNumber: title.mediaType == .television ? episode.episodeNumber : nil,
                episodeTitle: title.mediaType == .television ? episode.title : nil,
